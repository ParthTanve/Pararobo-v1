...
with st.sidebar:
    ...
    if user_role == 'Admin':
        ...
        with st.expander("🧑‍💼 My Employee Profile"):
...
if current_page == "Dashboard":
    ...
    role_tag = f" ({user_role})" if user_role in ['Intern', 'Employee'] else ""
    ...
    if user_role == 'Admin':
        ...
        st.info(f"💡 You are currently logged into the {user_role} Portal. Please use the sidebar to check your attendance, logs, and assigned tasks.")
