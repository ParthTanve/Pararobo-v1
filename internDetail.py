            ...
            for idx, row in df_pending.iterrows():
                with st.container(border=True):
                    ...
                    if is_half_day_intent:
                        ...
                        if late_count > 1:
                            approve_btn_text = "❌ Approve (Mark Absent)"
                            target_status = "Absent"
                        else:
                            if is_checkin:
                                approve_btn_text = "✅ Approve (Half Day Penalty)"
                    ...
                    with c2:
                        ...
                        if is_half_day_intent:
                            ...
                            if late_count > 1:
                                st.markdown(f"<span style='color:#ff4b4b; font-size: 13px;'>⚠️ Warning: {late_count} Late Offenses. Will be marked Absent.</span>", unsafe_allow_html=True)
                            else:
                                st.markdown("<span style='color:#ff9900; font-size: 13px;'>⚠️ Warning: 1st Late Offense. Will be penalized as Half Day.</span>", unsafe_allow_html=True)
            ...
            with st.container(border=True):
                ...
                if photo:
                    ...
                    if internship_type == "Part-Time Internship":
                        ...
                        time_msg_in, time_msg_out = "Check-In has not started yet.", "Check-Out is only allowed between 02:50 PM and 03:30 PM for Part-Time."
                        ...
                        if slot == "10:00 AM to 1:30 PM":
                            ...
                            time_msg_in, time_msg_out = "Check-In has not started yet.", "Check-Out is only allowed between 02:00 PM and 2:30 PM for Slot 1."
                        else: 
                            checkin_start, checkin_end, checkout_start, checkout_end = datetime.time(13, 50), datetime.time(14, 10), datetime.time(18,25), datetime.time(19, 00)
