...
import pytz
import os # 🟢 Added to read .env
from dotenv import load_dotenv # 🟢 Added to read .env

# 🟢 NAYA LOGIC: Firebase Database (db) aur config se sirf zaroori cheezein import
from config import is_valid_email, db

# 🟢 .env FILE SE SMTP VARIABLES LOAD KARNA
load_dotenv()
                ...
                if not mail_attachment:
                    ...
                    with st.spinner("Preparing and sending professional email to HR..."):
                        try:
                            ...
                            # 🟢 ROBUST FIX: Using Port 587 with STARTTLS (Better for Cloud Servers)
                            try:
