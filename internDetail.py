...
def get_month_stats(intern_name):
    ...
    # 🟢 FIX: Half Day ko stat counter mein add kiya
    ...
    for day in range(1, today.day + 1):
        ...
        elif status == 'Half Day': half_day += 1  # Half day check
...
def generate_calendar_html(intern_name, year, month):
    ...
    .status-halfday { background-color: rgba(52, 152, 219, 0.1); color: #3498db; border: 1px solid #3498db; } /* 🟢 Half Day Blue CSS */
    </style>
        ...
        for i, day in enumerate(week):
            if day == 0: html += "<td class='empty'></td>"
                ...
                if d > today: display_status = ""
                    ...
                    elif status == 'Half Day': display_status, badge_class = "Half Day", "status-halfday" # 🟢 Half Day HTML Check
