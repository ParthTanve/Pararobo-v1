...
# 🟢 NAYA LOGIC: SMTP Credentials for sending emails
SMTP_EMAIL = "tera_system_email@gmail.com"  # Apna email yaha daal
SMTP_PASSWORD = "wo_16_digit_ka_app_password" # Apna App Password yaha daal