...
# ==========================================
# UNIVERSAL BACKEND DATABASE INIT (FIREBASE SAFEGUARDED)
# ==========================================
def init_auth_db():
    try:
        users_ref = db.collection("users")
        
        # Safe query try karenge taaki crash na ho
        try:
            dummy_docs = users_ref.where("email", "==", "admin@pararobo.com").get()
            for doc in dummy_docs:
                doc.reference.delete()
        except Exception:
            pass # Index ya query issue ko ignore karega taaki app crash na ho
...
# ==========================================
# BACKEND CORE: MULTI-ROLE VERIFICATION (CACHING REMOVED FOR STABILITY)
# ==========================================
...
# ==========================================
# SESSION MANAGEMENT (30 Min Persistence)
# ==========================================
...
def check_session(token):
    ...
    if doc.exists:
        data = doc.to_dict()
        # 🟢 30 Minute tak login zinda rahega
